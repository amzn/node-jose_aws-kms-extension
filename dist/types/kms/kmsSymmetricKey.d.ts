...
export declare class KMSSymmetricKey {
     ...
     */
    wrap(encryptionAlgorithm: string, kmsDataKeyGenerationResult: KMSDataKeyGenerationResult): KMSDataKeyGenerationResult;
    /**
     ...
     */
    unwrap(encryptionAlgorithm: string, wrappedKey: Uint8Array): Promise<Uint8Array | undefined>;
}
